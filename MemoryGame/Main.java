...
public class Main {
    ...
    public static void kayittanAl(){
        ...
        if(file.exists()){
            System.out.print("Kaydettiğiniz yerden devam etmek istiyormusunuz?(yes or no): ");
    ...
    public static void main(String[] args) {
        ...
        while(oyunBittiMi() == false){
            ...
            System.out.print("Çıkış için basınız(yes yada no): ");
            String cikis = scanner.nextLine();
            
            if(cikis.equals("yes")){
                System.out.print("Oyunu kaydetmek istiyormusunuz?(Yes or No): ");
